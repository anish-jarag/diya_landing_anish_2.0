...
export const headerData = {
  links: [
    ...
    { text: 'Features', href: getPermalink('/#features') },
    {
      text: 'Why DIYA',
      links: [
        { text: 'Student Experience', href: '#student' },
        { text: 'Teacher Experience', href: '#teacher' },
        { text: 'Mobile Experience', href: '#mobile' },
      ],
    },
...
export const footerData = {
  ...
  footNote: '© 2025 DIYA Edutech | All rights reserved',
};
